...
const (
	...
	LogAppealSubmitSuccess            = "review appeal submit success: appeal_id=%d review_id=%d appellant=%d"
	LogAppealSubmitFailed             = "review appeal submit failed: review_id=%d appellant=%d error=%v"
	LogAppealListSuccess              = "review appeal list success: viewer=%d count=%d"
	LogAppealReviewSuccess            = "review appeal review success: appeal_id=%d review_id=%d action=%s admin=%d"
	LogAppealReviewFailed             = "review appeal review failed: appeal_id=%d admin=%d error=%v"
	LogAppealCreditRollback           = "review appeal credit rollback: appeal_id=%d user_id=%d delta=%d"
)
