...
type Review struct {
	...
	// CreditDelta is the score change this review ACTUALLY caused (after the
	// [0,300] clamp). Appeals roll it back exactly, rather than the nominal
	// rating delta, so a review at the floor/ceiling restores only what it
	// really changed.
